...
export function NewHabitForm(){
    ...
    return (
        <form 
            ...
            <button type="submit" className="mt-6 ounded-lg p-4 flex items-center justify-center gap-3 font-semibold bg-green-600 hover:bg-green-500 transition-colors focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-offset-2 focus:ring-offset-zinc-900">
